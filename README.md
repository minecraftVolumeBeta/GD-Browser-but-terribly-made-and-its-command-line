...
This project is completely unfinished so literally **any** contribution/bug hunters would help. This is by no means actively maintained by me as this is kind of a personal project done for a laugh (long story short i lost a bet). If you encounter any MAJOR bugs (like leaking data and stuff), please DO immediately report it. I'll probably fix it when I see it (and make sure to add like 10 exclamation marks to your report title so i can remind myself how much i screwed up!)

Also if this project for absolutely no reason blows up somehow, i *might* transfer ownership to someone who has much more time than me because i already know aint no way i will have time to handle more than 3 bug reports or feature requests per day LOL
